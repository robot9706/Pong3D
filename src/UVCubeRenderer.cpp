...
int UVCubeRenderer::_stride = 0;
unsigned int UVCubeRenderer::_vbo = 0;
unsigned int UVCubeRenderer::_ibo = 0;
unsigned int UVCubeRenderer::_vao = 0;

void UVCubeRenderer::Init()
{
    //POS UV NRM
    //XYZ TS XYZ = 8
...
void UVCubeRenderer::BindVAO()
{
    glBindVertexArray(_vao);
}

void UVCubeRenderer::UnbindVAO()
{
    glBindVertexArray(0);
}
